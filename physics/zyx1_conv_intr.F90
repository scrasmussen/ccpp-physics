...
!=========================================================================================
 ...
 subroutine zyx1_conv_intr_tend(ztodt, landfrac, lhflx, shflx, pblh, &
     tpert,qpert,gradt, gradq, vort3,&
...
#ENDIF
   ...
   call zyx1_conv_tend(   lchnk   ,ncol       ,nstep                                 , &
               ...
               .5_r8*ztodt   ,state%lat     ,state%lon, landfrac   ,lhflx  , shflx   , & 
               state%ps      ,bfls_t     ,bfls_q                                     , &
               omega         ,tpert      ,qpert, gradt, gradq, vort3                 , &
               tke(:,pver)   , massflxbase_p  ,  mcon          ,cme        , cape    , &
               dlf           ,pflx       ,zdu           ,rprd                        , &
...
!         state1%t,state1%pmid,state1%pdel,state1%q(:pcols,:pver,1),  &
         state1%t,state1%pmid,state1%pdel,state1%q(:pcols,:pver,1), state1%lat, state1%lon, &
